...
public class AddEeeBook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(AddEeeBook.this);
    ...
    public void addbook(){
        ...
        if(bookname.equals("") || writername.equals("") || edition.equals("") || amount.equals("")){
            ...
            Toast.makeText(AddEeeBook.this,"Empty field detected",Toast.LENGTH_SHORT).show();
            return;
        }

        Call<CseBookList> addbook = MainActivity.apiInterface.addeeebook(bookname,writername,edition,amount);
        ...
        addbook.enqueue(new Callback<CseBookList>() {
            ...
            public void onResponse(Call<CseBookList> call, Response<CseBookList> response) {
                if(response.isSuccessful()){
                    ...
                    if(response.body().getResponse().equals("ok")){
                        Toast.makeText(AddEeeBook.this,"Book Listed",Toast.LENGTH_LONG).show();
                    }
                    else if(response.body().getResponse().equals("exist")){
                        Toast.makeText(AddEeeBook.this,"Book exist",Toast.LENGTH_LONG).show();
                    }
                    else{
                        Toast.makeText(AddEeeBook.this,"Error",Toast.LENGTH_LONG).show();
                    }
                }
            }
            ...
            public void onFailure(Call<CseBookList> call, Throwable t) {
                ...
                progressDialog.dismiss();
                Toast.makeText(AddEeeBook.this,"Error Occured",Toast.LENGTH_LONG).show();
            }
        });
    }
}
