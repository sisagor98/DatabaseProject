...
public class AddCivilBook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(AddCivilBook.this);
    ...
    public void addbook(){
        ...
        if(bookname.equals("") || writername.equals("") || edition.equals("") || amount.equals("")){
            ...
            Toast.makeText(AddCivilBook.this,"Empty field detected",Toast.LENGTH_SHORT).show();
            return;
        }

        Call<CseBookList> addbook = MainActivity.apiInterface.addcivilbook(bookname,writername,edition,amount);
        ...
        addbook.enqueue(new Callback<CseBookList>() {
            ...
            public void onResponse(Call<CseBookList> call, Response<CseBookList> response) {
                if(response.isSuccessful()){
                    ...
                    if(response.body().getResponse().equals("ok")){
                        Toast.makeText(AddCivilBook.this,"Book Listed",Toast.LENGTH_LONG).show();
                    }
                    else if(response.body().getResponse().equals("exist")){
                        Toast.makeText(AddCivilBook.this,"Book already exist",Toast.LENGTH_LONG).show();
                    }
                    else
                        Toast.makeText(AddCivilBook.this,"Error",Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(Call<CseBookList> call, Throwable t) {
                ...
                progressDialog.dismiss();
                Toast.makeText(AddCivilBook.this,"Error Occured",Toast.LENGTH_LONG).show();
            }
        });
    }
}
